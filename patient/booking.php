             ...
             <tr class="menu-row" >
                ...
                <tr class="menu-row">
                    <td class="menu-btn menu-icon-doctor">
                        <a href="doctors.php" class="non-style-link-menu"><div><p class="menu-text">All Saloons</p></a></div>
                    </td>
                </tr>
                ...
                <tr >
                    ...
                    <td >
                            <form action="schedule.php" method="post" class="header-search">
                                        ...
                                        <input type="search" name="search" class="input-text header-searchbar" placeholder="Search Saloon name or Email or Date (YYYY-MM-DD)" list="doctors" >&nbsp;&nbsp;
                                            ...
                                            <div  class="dashboard-items search-items"  >
                                                ...
                                                <div style="width:100%">
                                                        ...
                                                        <div class="h3-search" style="font-size:18px;line-height:30px">
                                                            Saloon name:  &nbsp;&nbsp;<b>'.$docname.'</b><br>
                                                            Saloon Email:  &nbsp;&nbsp;<b>'.$docemail.'</b> 
                                                        </div>
